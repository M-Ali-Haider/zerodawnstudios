...
const Model = () => {
  ...
  useFrame(() => {
    meshRefs.current.forEach((mesh, index) => {
      if (mesh) {
        // mesh.rotation.z += 0.01 * (index % 2 === 0 ? 1 : -1);
    ...
    <group ref={groupRef} dispose={null}>
      <group scale={0.01}>
        <PerspectiveCamera
          ...
          near={70}
          fov={45}
          position={[675.76, 178.47, 227.72]}
          rotation={[-0.665, 1.166, 0.624]}
        />
        ...
        <OrthographicCamera
          ...
          far={100000}
          near={0}
          position={[-408.202, 10.93, -266.606]}
          rotation={[-3.101, -0.992, -3.107]}
        />

        <group rotation={[-0.073, -1, -1.5]}>
...
useGLTF.preload("/Scene/chips.gltf");
